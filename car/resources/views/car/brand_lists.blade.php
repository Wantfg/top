...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/car/select2_metro.css')}}" />

    <link rel="stylesheet" href="{{asset('css/car/DT_bootstrap.css')}}" />
...
<script type="text/javascript" src="{{ asset('js/car/select2.min.js') }}"></script>

<script type="text/javascript" src="{{ asset('js/car/jquery.dataTables.js') }}"></script>

<script type="text/javascript" src="{{ asset('js/car/DT_bootstrap.js') }}"></script>
...
<script src="{{ asset('js/car/table-editable.js') }}"></script>
