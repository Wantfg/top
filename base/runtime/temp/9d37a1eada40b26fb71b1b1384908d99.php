<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\wamp64\www\top\base\public/../application/admin/view/default/base\list.html";i:1511097513;s:80:"D:\wamp64\www\top\base\public/../application/admin/view/default/public\base.html";i:1511097513;s:84:"D:\wamp64\www\top\base\public/../application/admin/view/default/public\sidemenu.html";i:1511097513;s:83:"D:\wamp64\www\top\base\public/../application/admin/view/default/public\sidebar.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="btn-group seach-main col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="layui-input-inline value-html">
                        ...
                        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
                            <?php $_5b228d8163886=parse_field_attr($vo['extra']); if(is_array($_5b228d8163886) || $_5b228d8163886 instanceof \think\Collection || $_5b228d8163886 instanceof \think\Paginator): if( count($_5b228d8163886)==0 ) : echo "" ;else: foreach($_5b228d8163886 as $k=>$vos): ?>
...
<div class="extra_list" style="display: none;">
    ...
    <div class="<?php echo $vo['name']; ?>_extra_html">
        <?php switch($vo['type']): case "select": ?>
        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
            <?php $_5b228d8163516=parse_field_attr($vo['extra']); if(is_array($_5b228d8163516) || $_5b228d8163516 instanceof \think\Collection || $_5b228d8163516 instanceof \think\Paginator): if( count($_5b228d8163516)==0 ) : echo "" ;else: foreach($_5b228d8163516 as $k=>$vos): ?>
            <option value="<?php echo $k; ?>" <?php if($k == $vo['value']): ?> selected="selected" <?php endif; ?>><?php echo $vos; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php break; case "date": ?>date<?php break; case "datetime": ?>date<?php break; default: ?><input name="seach_all[value][]" class="layui-input" type="text" value="<?php echo $vo['value']; ?>">
