<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wamp64\www\top\base\public/../application/install\view\install\step2.html";i:1511097513;s:74:"D:\wamp64\www\top\base\public/../application/install\view\public\base.html";i:1511097513;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <li><a><?php if(\think\Session::get('update') == '1'): ?>升级<?php else: ?>安装<?php endif; ?><span class="caret"></span></a></li>
    <li><a>完成<span class="caret"></span></a></li>
    ...
    <form action="" method="post" target="_self">
        <div class="col-xs-12 form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_HOST_M")): ?><?php echo SAE_MYSQL_HOST_M; else: ?>127.0.0.1<?php endif; ?>">
                </div>
                <div class="col-sm-7  text-left control-label">数据库服务器，数据库服务器IP，一般为127.0.0.1</div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">数据库名</label>
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_DB")): ?><?php echo SAE_MYSQL_DB; else: ?>twothink<?php endif; ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">数据库用户名</label>
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_USER")): ?><?php echo SAE_MYSQL_USER; else: ?>root<?php endif; ?>">
                </div>
            </div>
            <div  class="form-group">
                <label class="col-sm-2 control-label">数据库密码</label>
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_PASS")): ?><?php echo SAE_MYSQL_PASS; endif; ?>">
                </div>
            </div>
            <div  class="form-group">
                <label class="col-sm-2 control-label">数据库端口</label>
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="<?php if(defined("SAE_MYSQL_PORT")): ?><?php echo SAE_MYSQL_PORT; else: ?>3306<?php endif; ?>">
                </div>
                <div class="col-sm-7  text-left control-label">数据库服务连接端口，一般为3306</div>
            </div>
            <div  class="form-group">
                <label class="col-sm-2 control-label">数据表前缀</label>
                <div class="col-sm-3">
                    <input class="form-control" type="text" name="db[]" value="twothink_">
                </div>
                <div class="col-sm-7  text-left control-label">同一个数据库运行多个系统时请修改为不同的前缀</div>
            </div>
        </div>
        ...
        <div class="col-xs-12 form-horizontal">
            <div  class="form-group">
                ...
                <div class="col-sm-10"><h2>创始人帐号信息</h2></div>
            </div>
            <div  class="form-group">
            ...
            <div  class="form-group">
                ...
                <div class="col-sm-7  text-left control-label">请填写正确的邮箱便于收取提醒邮件</div>
            </div>
        </div>
    </form>
</div>
